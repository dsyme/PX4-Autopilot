...
| 15 | `math::expo_deadzone` | `src/lib/mathlib/math/Functions.hpp` | 5 | ✅ Proved | `lean/FVSquad/ExpoDeadzone.lean` | Composed expo+deadzone; 8 theorems, 0 sorry (range, zero in dz, e=0 reduces, ±1 fixed points, odd symmetry, cubic extreme) |
