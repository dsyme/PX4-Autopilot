...
\title{Formal Verification of a UAV Flight Controller's Core Libraries with Lean~4:\\
       882 Theorems, Six Bugs, Zero Sorry in 54 Modules}
...
(no Mathlib), we verified \textbf{882~theorems} fully across \textbf{54~Lean modules}
...
\begin{itemize}
  \item A formal verification campaign covering \textbf{50+~C++ targets with Lean proofs}
        in 54~Lean modules, yielding \textbf{882~fully proved theorems} with
...
\textbf{882~theorems} are stated and proved with zero \texttt{sorry} in any proof
...
\begin{table}[t]
\centering
\caption{Lean 4 verification summary by file (54 files, 54+ C++ targets).
...
\hline
\textbf{Total}         &                                    & \textbf{882} & \textbf{0 sorry, 11 axioms} \\
\bottomrule
\end{tabular}
\end{table}
...
libraries using Lean~4. Across 51~Lean modules and 50+~C++ targets, we proved
882~theorems covering rate limiting, interpolation, filtering, statistics, data
